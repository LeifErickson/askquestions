...
<body>
<h2>Welcome to the <?php echo APP_TITLE; ?> site and/or mobile app, a web resource that helps you ask and answer.</h2>
<p>The <?php echo APP_TITLE; ?> site (<?php echo APP_URL; ?>) (herein after – the Application) and/or mobile app is a network project uniting the people who love to answer questions, and to ask questions to friends.</p>
