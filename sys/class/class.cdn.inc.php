...
class cdn extends db_connect
{
    ...
    public function uploadAnswerImg($imgFilename)
    {
        rename($imgFilename, ANSWER_PHOTO_PATH.basename($imgFilename));

        $result = array("error" => false,
                        "error_code" => ERROR_SUCCESS,
                        "fileUrl" => APP_URL."/".ANSWER_PHOTO_PATH.basename($imgFilename));
